  ...
  try {
    ...
    if (newTransactions.length > 0) {
      newTransactions.forEach(tx => {
        console.log(`New transaction: ${tx.txid}, Amount: ${tx.amount} sats, Minting required: ${tx.requiresMinting}`);
      });
    }
  } catch (error) {
...
// New endpoint to get pending mints
...
// New endpoint to mark a transaction as minted
